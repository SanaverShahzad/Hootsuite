    ...
    return (
        <>
           ...
           <Container className="inner-container">
               ...
               <Box mt={3} mb={4}  fontSize="34px" lineHeight="43px" color="#fff6e8" fontFamily="SourceSansPro-Regular" className={classes.savetxt}>Start managing and boosting Instagram performance with PEDDLE</Box>
