    ...
    return (
        <>
           ...
           <Container className="inner-container">
               ...
               <Box mt={1} mb={4}  fontSize="34px" lineHeight="43px" color="#fff6e8" fontFamily="SourceSansPro-Regular" className={classes.savetxt}>See PEDDLE's mobile app in action</Box>
