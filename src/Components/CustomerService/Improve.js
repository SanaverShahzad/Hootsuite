...
<ScrollAnimation animateIn="fadeIn">
          ...
          <Container className="inner-container">
              ...
              <Box  my={2}  textAlign="center" fontSize="34px" lineHeight="43px" color="#241f21" fontFamily="SourceSansPro-Regular" className={classes.extend}>Improve customer satisfaction through efficient collaboration</Box>
            <Grid container>
            <Hidden smDown>
                <Grid item lg={6} md={6} sm={6} >
               <div className={classes.heremargin}>
                <Box  my={2}  fontSize="20px" lineHeight="30px" color="#241f21" fontFamily="SourceSansPro-Bold">Resolve issues faster <span className={classes.across}> by setting up automated rules and keywords to triage incoming posts.</span> </Box>
                <Box  my={2}  fontSize="20px" lineHeight="30px" color="#241f21" fontFamily="SourceSansPro-Bold">Avoid duplicate responses <span className={classes.across}>by assigning messages to specific people or teams.</span> </Box>
                <Box  my={2}  fontSize="20px" lineHeight="30px" color="#241f21" fontFamily="SourceSansPro-Bold">Improve customer satisfaction <span className={classes.across}> with social customer service training and social media education for your reps.</span> </Box>
