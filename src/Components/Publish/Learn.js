...
import Engage from '../Assets/img/Engage_Icon_200528_173419.svg'
...
export default function Learn() {
    ...
    return (
      ...
      <CardActionArea>
        ...
        />
        <CardContent>
        <Box my={2}  fontSize="20px" lineHeight="30px" color="#241f21" fontFamily="SourceSansPro-Bold" className={classes.Engage}>Engage</Box>
        <Box my={2}  fontSize="16px" lineHeight="25px" color="#5b6063" fontFamily="SourceSansPro-Regular">Monitor and manage incoming messages</Box>
        </CardContent>
      </CardActionArea>
