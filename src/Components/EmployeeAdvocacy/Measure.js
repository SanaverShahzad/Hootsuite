...
import bookpost from '../Assets/img/Hootsuite_EmployeeAdvocacy_Illustration3@2x.png'
...
<ScrollAnimation animateIn="fadeIn">
          ...
          <Container className="inner-container">
              ...
              <Box  my={2}  textAlign="center" fontSize="34px" lineHeight="43px" color="#241f21" fontFamily="SourceSansPro-Regular" className={classes.extend}>Measure your team’s participation—and your content’s performance</Box>
            <Grid container spacing={2}>
            <Hidden smDown>
                <Grid item lg={6} md={6} sm={6} >
               <div className={classes.heremargin}>
                <Box  my={2}  fontSize="20px" lineHeight="30px" color="#241f21" fontFamily="SourceSansPro-Bold">Report on adoption <span className={classes.across}>  by measuring individual and organizational participation.</span> </Box>
                <Box  my={2}  fontSize="20px" lineHeight="30px" color="#241f21" fontFamily="SourceSansPro-Bold">Track what content resonates <span className={classes.across}> and its impact on your reach and website traffic.</span> </Box>
                <Box  my={2}  fontSize="20px" lineHeight="30px" color="#241f21" fontFamily="SourceSansPro-Bold">Optimize engagement<span className={classes.across}> through social content performance metrics.</span> </Box>
