...
<ScrollAnimation animateIn="fadeIn">
          ...
          <Container className="inner-container">
              ...
              <Box  my={2}  textAlign="center" fontSize="34px" lineHeight="43px" color="#241f21" fontFamily="SourceSansPro-Regular" className={classes.extend}>Safeguard your brand reputation and stay compliant</Box>
