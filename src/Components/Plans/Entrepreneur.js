...
export default function Price() {
    ...
    return (
        ...
        <Box mb={2} textAlign="center" fontSize="54px" lineHeight="60px" color="#143059" fontFamily="SourceSansPro-Bold">Entrepreneur</Box>
        <Box my={4} textAlign="center" fontSize="20px" lineHeight="30px" color="#241f21" fontFamily="SourceSansPro-Regular">After 30 days trial the packages of Entrepreneur are mention below</Box>
      ...
      <CardActionArea>
        ...
        <CardContent>
        <Box  textAlign="center" fontSize="48px" lineHeight="72px" color="#241f21" fontFamily="SourceSansPro-Bold">5 USD </Box>
      ...
      />
        ...
        label={   <Box fontSize="16px" pl={1} lineHeight="24px"  color="#241f21" fontFamily="SourceSansPro-Regular">Enter B2B Partnerships </Box>}
        />
      <FormControlLabel
                   className={classes.listfeatures}
        control={<ClearIcon className={classes.cross} fontSize="small" />}
      ...
      />
        <FormControlLabel
                          className={classes.listfeatures}
                control={<ClearIcon className={classes.cross} fontSize="small" />}
                label={   <Box fontSize="16px" pl={1} lineHeight="24px"  color="#241f21" fontFamily="SourceSansPro-Regular">Team Members </Box>}
              />
                <FormControlLabel
                          className={classes.listfeatures}
                control={<DoneIcon fontSize="small" />}
              ...
              className={classes.listfeatures}
        control={<DoneIcon fontSize="small" />}
        label={   <Box fontSize="16px" pl={1} lineHeight="24px"  color="#241f21" fontFamily="SourceSansPro-Regular">Brand Ambassadors  (Limited to 2) </Box>}
        />
