...
import Pandaphoto  from '../Assets/img/marketo.png'
import Accor  from '../Assets/img/canucks.png.png'
import marketo  from '../Assets/img/Accor_Hotels.png'
    ...
    return (
        <div>
            <Box bgcolor="#eeebe8" py={6}>
                ...
                textAlign="center"
                >
                Trusted by leading health care organizations including:
                </Box> 
                ...
                <Grid container spacing={4} >
                    ...
                    <div  className={classes.pandaimg}>
                    <img src={Accor}  width={99} height={95}   />
                   
                    </div>
                     </Grid>
                    <Grid item lg={3} md={3} sm={6} xs={12}> 
                    <div  className={classes.pandaimg}>
                    <img src={marketo}  width={164} height={44}   />
                    </div>
                    </Grid>
